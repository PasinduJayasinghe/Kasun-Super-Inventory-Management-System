...
namespace KasunSuperInventoryManagementSystem
{
    public partial class Sales : Form
    {
        ...
        private void textBox3_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            cmd.CommandText = "select * from stock where productName like('" + textBox3.Text + "%') ";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
        ...
        private void listBox1_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    textBox3.Text = listBox1.SelectedItems.ToString();
        ...
        private void textBox4_Enter(object sender, EventArgs e)
        {
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select top 1*from purchaseMaster where productName = '" + textBox3.Text + "' order by id desc";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd1.CommandText = "select * from stock where productName ='" + textBox3.Text + "'";
            ...
            {
                MessageBox.Show("This is not available");
            }
            else
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd1 = con.CreateCommand();
            cmd1.CommandType = CommandType.Text;
            cmd1.CommandText = "insert into orderUser values('"+textBox1.Text+"','"+textBox2.Text+"','"+comboBox1.Text+"','"+dateTimePicker1.Value.ToString("dd/mm/yyyy")+"')";
            cmd1.ExecuteNonQuery();

            SqlCommand cmd2 = con.CreateCommand();
            cmd2.CommandType = CommandType.Text;
            cmd2.CommandText = "select top 1*from oderUser order by id desc";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                cmd3.CommandText = "insert into orderItems values('" + orderId.ToString() + "','" + dr["product"].ToString() + "','" + dr["price"].ToString() + "','" + dr["qty"].ToString() + "','" + dr["total"].ToString() +"')";
                ...
                cmd6.CommandText = "update stock set productQty=productQty-"+qty+" where productName = '"+pname.ToString()+"'";
